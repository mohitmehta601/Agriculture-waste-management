...
const Cart = () => {
  ...
  const getProductImage = (productName: string) => {
    const imageMap: { [key: string]: string } = {
      'Rice Husk': 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=100&h=100&fit=crop',
      'Wheat Straw': 'https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=100&h=100&fit=crop',
      'Sugarcane Bagasse': 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=100&h=100&fit=crop',
      'Coconut Fiber': 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=100&h=100&fit=crop',
      'Peanut Shell': 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=100&h=100&fit=crop',
      'Corn Stalks': 'https://images.unsplash.com/photo-1517022812141-23620dba5c23?w=100&h=100&fit=crop'
    };
    return imageMap[productName] || 'https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?w=100&h=100&fit=crop';
  };
          ...
          <Card className="bg-white/90 backdrop-blur-sm border-gray-200 shadow-xl animate-scale-in">
            <CardContent className="py-16 text-center">
              ...
              <p className="text-gray-500 mb-8 max-w-md mx-auto">
                Add some agricultural waste products to get started on your sustainable journey
              </p>
              <Button 
                onClick={() => navigate('/marketplace')}
          ...
          <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    {cartItems.map((item, index) => (
                      ...
                      >
                        ...
                        <div className="flex-1 w-full sm:w-auto">
                          ...
                          <p className="text-sm text-green-600 font-medium">₹{item.price.toFixed(2)} per kg</p>
                          <p className="text-sm text-gray-500">Stock: {item.stock} kg available</p>
                        </div>
            ...
            <div className="lg:col-span-1">
              <Card className="bg-white/90 backdrop-blur-sm border-blue-200 shadow-xl sticky top-8 animate-fade-in">
                <CardHeader>
                  <CardTitle className="text-xl sm:text-2xl text-blue-800">Order Summary</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
